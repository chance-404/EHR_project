...
import { ConfirmDeleteDialog } from "../confirm-case-delete/confirm-case-delete";
...
export class SurgeryCaseComponent implements OnInit{
	...
	ngOnInit(): void {
		...
		this.SurgeryCaseForm.patchValue({
			...
			startTime: this.currentSurgeryCase.startTime,
	...
	deleteCase(SurgeryCase: SurgeryCase) {
		...
		const dialogRef = this.dialog.open<boolean>(ConfirmDeleteDialog, {
			backdropClass: 'cdk-overlay-dark-backdrop',
			panelClass: 'confirm-case-delete-dialog'
		});
