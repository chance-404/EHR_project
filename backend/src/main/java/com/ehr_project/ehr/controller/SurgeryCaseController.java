...
public class SurgeryCaseController {
    ...
    public ResponseEntity<SurgeryCase> getPatientByMrn (@PathVariable Long surgeryCaseId) {    
    ...
    public ResponseEntity<?> deleteSurgeryCase(@PathVariable Long surgeryCaseId) {
